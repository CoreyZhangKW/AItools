...
- **Crucial for Listed/Delisted Companies**: If the company is currently listed or was previously listed (A-share, HKEX, US markets), you MUST search for and review its public disclosures, specifically the latest Annual Reports (年报), Semi-Annual Reports (半年报), other regular or ad hoc reports and disclsoures, and its original IPO Prospectus (招股书) in Chinese or English.
...
- Identify the company's core assets (e.g., specific plants, machinary, patents, key infrastructure) and their operational status.
...
- Summarize the company's **Core Competitive Advantages** (aim for 4-6 distinct, well-supported pointsw).
...
3. **核心业务与核心资产 (Core Business & Assets)**: Detailed breakdown of segments, prodcuts and services, and key assets.
